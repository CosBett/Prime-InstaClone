...
class Follow(models.Model):
    follower = models.ForeignKey(User_profile, on_delete=models.CASCADE, related_name='following')
    followed = models.ForeignKey(User_profile, on_delete=models.CASCADE, related_name='followers')
